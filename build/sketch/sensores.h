...
bool entroncamentoDir();     // true se os 4 sensores da direita vêem preto (entroncamento à direita)
bool curvaOuEntroncamento(); // true se estiver em uma curva ou entroncamento